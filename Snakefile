...
proj_dom["id"] = proj_dom.area + "_" + proj_dom.project + "_" + proj_dom.activity + "_" + proj_dom.domain + "_" + proj_dom.institute + "_" + proj_dom.model + "_" +  proj_dom.experiment + "_" +  proj_dom.ensemble + "_" + proj_dom.rcm + "_" + proj_dom.downscaling
