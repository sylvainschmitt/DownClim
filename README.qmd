...
Extract histograms of values for land of the baseline. Similarly, [hist_proj_raw](https://github.com/sylvainschmitt/DownClim/blob/dev/rules/hist_proj_raw.py) and [hist_proj_ds](https://github.com/sylvainschmitt/DownClim/blob/dev/rules/hist_proj_ds.py) extract histograms for the projection before and after downscaling.
...
Compute evaluation metrics (CC, RMSEP, SDE, Bias) for the projection after downscaling. Similarly, [eval_proj_raw](https://github.com/sylvainschmitt/DownClim/blob/dev/rules/eval_proj_raw.py) compute the metrics before downscaling.
